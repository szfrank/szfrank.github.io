...
创建一个字典并输出:
    ...
    NSDictionary *dic = @{@"name"  : @"BY",
                           @"My bolg" : @"http://ifrankyu.top",
                           @"count" : @(11),
                           @"strData" : strData,
                           @"dicData" : dicData,
                           @"set"     : set,
                           @"Unicode" : @"😀😁🤣😂😄",
                           @"contact" : @[@"BY Blog:http://ifrankyu.top",
                                          @"GitHub:https://github.com/ifrankyu",
...
代码及Demo地址：[GitHub](https:/ifrankyum/qiubaiying/BYFoundationLog)
